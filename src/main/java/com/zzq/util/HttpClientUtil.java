...
//            httpClient = new SSLClient();
            ...
            //用户的静态头属性
            httpPost.addHeader("X-ECAPI-Authorization","");
            ...
            String signStr =  HmacSHA256.getHmacSHA256(currentTimeStr+ "test="+"ae4207657e41a6a47b3bcd748ac77746", yunscsginkey)+","+currentTimeStr;
